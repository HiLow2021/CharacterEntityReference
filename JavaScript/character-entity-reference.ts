 ...
 * @returns 置きかえられた文字列。
 */
function convertFromCharacterEntityReferenceBasic(source: string): string {
    let txt = source;
 ...
 */
function convertFromCharacterEntityReferenceAllBasic(sources: string[]): string[] {
 ...
 * @returns 置きかえられた文字列。
 */
function convertFromCharacterEntityReference(source: string): string {
    let txt = source;
 ...
 * @returns 置きかえられた文字列の配列。
 */
function convertFromCharacterEntityReferenceAll(sources: string[]): string[] {
    for (let i = 0; i < sources.length; i++) {
 ...
 * @returns 置きかえられた文字列。
 */
function convertToCharacterEntityReferenceBasic(source: string): string {
    let txt = source;
 ...
 * @returns 置きかえられた文字列の配列。
 */
function convertToCharacterEntityReferenceAllBasic(sources: string[]): string[] {
    for (let i = 0; i < sources.length; i++) {
 ...
 * @returns 置きかえられた文字列。
 */
function convertToCharacterEntityReference(source: string, escapeSequenceFlag: boolean): string {
    let txt = source;
 ...
 * @returns 置きかえられた文字列の配列。
 */
function convertToCharacterEntityReferenceAll(sources: string[], escapeSequenceFlag: boolean): string[] {
    for (let i = 0; i < sources.length; i++) {
...
export {
    convertFromCharacterEntityReferenceBasic,
    convertFromCharacterEntityReferenceAllBasic,
    convertFromCharacterEntityReference,
    convertFromCharacterEntityReferenceAll,
    convertToCharacterEntityReferenceBasic,
    convertToCharacterEntityReferenceAllBasic,
    convertToCharacterEntityReference,
    convertToCharacterEntityReferenceAll
};
